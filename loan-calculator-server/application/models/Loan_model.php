   ...
   // function Loan_model(){
    ...
    function saveLoan($post)
    {
        ...
        if ($post['incomes']) {
		 ...
		 /* $this->db->where('loanId', $post['loanId']);
            $this->db->delete('incomes_history');
         */
        ...
        if ($post['incomes']) {
            foreach ($post['incomes'] as $income) {
                ...
                $this->db->insert('incomes_history', $data);
            }
        }
        ...
        if ($post['debts']) {
            foreach ($post['debts'] as $debit) {
                ...
                $this->db->insert('debits_history', $data);
            }
        }
