...
else if(isset($_REQUEST['cusid']))
{
	...
	$msg=explode('{URL}',$msg);
	$msg=$msg[0].'<br/><a href="https://loanapp-app.herokuapp.com/material/customersignup.php?id='.sha1($to).base64_encode($user_id).'" target="_blank">Click Here For Signup?</a>';
