                  ...
                  <form method="post" action="#" id="customer_form">
                     ...
                     <div class="panel panel-default" id="bpmiform" style="display:none;">
                        <div class="panel-heading">
                           <div class="panel-title">BPMI</div>
                        </div>
                        <div class="panel-body">
													<div class="col-md-12">
													<div class="col-md-4">
                           <div class="form-group">
                              <label class="control-label">ITV To *</label>
                              <input type="text" name="itvto" id="itvto" class="form-control" placeholder="Enter ITV To*" oninvalid="this.setCustomValidity('please enter ITV To')" onchange="this.setCustomValidity('')" required>
                           </div>
						              </div>
									      <div class="col-md-4">
                           <div class="form-group">
                              <label class="control-label">ITV From *</label>
                              <input type="text" name="itvfrom" id="itvfrom" class="form-control" placeholder="Enter ITV From*" oninvalid="this.setCustomValidity('please enter ITV From')" onchange="this.setCustomValidity('')" required>
                           </div>
						              </div>
									      <div class="col-md-4">
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="bpmi" id="bpmi" class="form-control" placeholder="Enter BPMI*" oninvalid="this.setCustomValidity('please enter bpmi')" onchange="this.setCustomValidity('')" required>
												...
												<div class="col-md-4">
                           <div class="form-group">
                              <label class="control-label">Term From *</label>
                              <input type="text" name="termfrom" id="termfrom" class="form-control" placeholder="Enter Term From*" oninvalid="this.setCustomValidity('please enter term from')" onchange="this.setCustomValidity('')" required>
                           </div>
						              </div>
									  </div>
									  <div class="col-md-12">
									      <div class="col-md-4">
                           <div class="form-group">
                              <label class="control-label">Term To</label>
                              <input type="text" name="termto" id="termto" class="form-control" >
                           </div>
						              </div>
									       <div class="col-md-4">
