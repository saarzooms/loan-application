   ...
   <section>
    <div class="content-wrapper">
					<div class="clearfix">
						...
						<button type="button" class="btn btn-primary" id="new"><em class="fa fa-plus"></em> Business Type</button>		
						</div>
          </div>  
            <!-- START row-->
            <div class="row">
                  ...
                  <form method="post" action="#" id="business_form">
                     ...
                     <div class="panel panel-default" id="businessform" style="display:none;">
                        <div class="panel-heading">
                           <div class="panel-title">New Business Type</div>
                        </div>
                        <div class="panel-body">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="type" id="type" class="form-control" placeholder="Enter Business Type*" oninvalid="this.setCustomValidity('please enter business type')" onchange="this.setCustomValidity('')" required>
                           </div>
						              </div>
									      <div class="col-md-4">
                       </div>
