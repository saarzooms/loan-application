...
<head>
   ...
   <title>Loanofficer Report</title>
    ...
    <div class="content-wrapper">
            ...
            <div class="row">
               <div class="col-md-12">
                     ...
                     <!-- START panel-->
                     <div class="panel panel-default" id="bpmiform">
...
<!-- DATATABLES-->
  ...
  function loadloanofficerlist()
  {
	  var id='all';
	$.ajax({ 
						type: "POST",
						url: "ajax/report_data.php?id="+id,
						//dataType:'json',
