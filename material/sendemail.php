...
if(isset($_POST))
{
	...
	$msg=explode('{URL}',$msg);
	$msg=$msg[0].'<br/><a href="https://loanapp-app.herokuapp.com/material/calculator.php#/loan-calculator/customer-view/'.sha1($officerid).base64_encode($loanid).'" target="_blank">Loan Calculator</a>';
